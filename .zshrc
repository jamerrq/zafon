...
# Configurar estilos para zsh-syntax-highlighting
typeset -A ZSH_HIGHLIGHT_STYLES

ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#ff7db0,bold' # Sólo para resaltar con el tema Hackerman
...
export PATH="$PATH:/home/jamerrq/.lmstudio/bin"
