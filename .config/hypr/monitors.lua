...
-- The per-output layout lives in hypr/zafon.lua, which hyprland.lua requires
-- last, so it overrides the catch-all above. Only the two scale values are
-- kept here, since they are the knobs this file exists to expose.
